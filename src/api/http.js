...
class Http {
    ...
    get = (url, params) => {
        return axios.get(url, { params }).then(this.processResp);
    };
    /**
     * post方法，对应post请求
     * @param {String} url [请求的url地址]
     ...
     */
    put = (url, params) => {
        return axios.put(url, params).then(this.processResp);
    };
    /**
     * patch方法，对应patch请求
     * @param {String} url [请求的url地址]
     ...
     */
    patch = (url, params) => {
        return axios.patch(url, params).then(this.processResp);
    };
    /**
     * delete方法，对应delete请求
     * @param {String} url [请求的url地址]
     ...
     */
    delete = (url, params) => {
        return axios.delete(url, params).then(this.processResp);
    };
}
